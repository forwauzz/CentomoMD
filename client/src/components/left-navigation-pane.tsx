...
export function LeftNavigationPane({
  ...
  return (
    <div className={`fixed left-0 top-0 h-full bg-white border-r border-gray-200 shadow-sm transition-all duration-300 z-30 no-print ${
        ...
        <div className="border-b border-gray-100">
          ...
          {!isCollapsed && !sectionsCollapsed.formActions && (
            ...
            >
              ...
              {!isCollapsed && <span className="ml-2">{t.save}</span>}
            </Button>
        ...
        <div className="border-b border-gray-100">
          ...
          {!isCollapsed && !sectionsCollapsed.formManagement && (
            ...
            >
              ...
              {isCollapsed && completedFormsCount > 0 && (
                <Badge variant="secondary" className="absolute -top-1 -right-1 h-5 w-5 p-0 flex items-center justify-center text-xs">
                  {completedFormsCount}
                </Badge>
              )}
